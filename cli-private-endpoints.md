...
2. Run the installer:
   ...
   **Installers:**
   - [Mac OS X 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/IBM_Cloud_CLI_2.27.0.pkg)
   - [Mac OS X M1/ARM](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/IBM_Cloud_CLI_2.27.0_arm64.pkg) **(provided as-is)**
   - [Windows&trade; 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/IBM_Cloud_CLI_2.27.0_amd64.exe)
   - [Windows&trade; 32-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/IBM_Cloud_CLI_2.27.0_386.exe)
   - [Linux&trade; 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/IBM_Cloud_CLI_2.27.0_amd64.tar.gz)
   - [Linux&trade; 64-bit ARM](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/IBM_Cloud_CLI_2.27.0_arm64.tar.gz)
   - [Linux&trade; 32-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/IBM_Cloud_CLI_2.27.0_386.tar.gz)
   - [PowerLinux&trade; 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/IBM_Cloud_CLI_2.27.0_ppc64le.tar.gz)
   - [System/390 Linux&trade; 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/IBM_Cloud_CLI_2.27.0_s390x.tar.gz)
...
3. Add to the `PATH` environment variable and enable shell autocompletion.
   ...
   * For shell autocompletion support (Mac and Linux&trade; only), see [Enabling shell autocompletion for IBM Cloud CLI](/docs/reference/ibmcloud?topic=cli-shell-autocomplete).

### Binary files
{: #install-custom-binary-files}

   - [Mac OS X 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/binaries/IBM_Cloud_CLI_2.27.0_macos.tgz)
   - [Windows&trade; 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/binaries/IBM_Cloud_CLI_2.27.0_windows_amd64.zip)
   - [Windows&trade; 32-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/binaries/IBM_Cloud_CLI_2.27.0_windows_386.zip)
   - [Linux&trade; 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/binaries/IBM_Cloud_CLI_2.27.0_linux_amd64.tgz)
   - [Linux&trade; 64-bit ARM](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/binaries/IBM_Cloud_CLI_2.27.0_linux_arm64.tgz)
   - [Linux&trade; 32-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/binaries/IBM_Cloud_CLI_2.27.0_linux_386.tgz)
   - [PowerLinux&trade; 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/binaries/IBM_Cloud_CLI_2.27.0_linux_ppc64le.tgz)
   - [System/390 Linux&trade; 64-bit](https://ibm-cloud-cli.s3.private.us.cloud-object-storage.appdomain.cloud/2.27.0/binaries/IBM_Cloud_CLI_2.27.0_linux_s390x.tgz)
